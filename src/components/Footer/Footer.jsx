      ...
      <div className="footer-container">
        ...
        <div className="footer-body">
          <div className="footer-body__content">
            <p>
              Somos la tienda favorita de todos los Skaboarders del País, con
              mas de 20 años de experiencia en el mercado y con los mejores
              Precios.
            </p>
          </div>
                ...
                <ul className="footer-body__nav-sublist">
                  <li className="footer-body__nav-subitem">
                    <a
                      ...
                      className="footer-body__nav-link"
                      onMouseEnter={(e) =>
                        handlePopoverOpen(e, "Sobre Nosotros")
                      }
                      onMouseLeave={handlePopoverClose}
                      aria-owns={
                        open && hoveredCategory === "Sobre Nosotros"
                          ? "mouse-over-popover"
                          : undefined
                      }
                      aria-haspopup="true"
        ...
        <div className="footer-attribute">
          <p>&copy; Dark Trip 2024. Todos los derechos reservados.</p>
        </div>
      </div>
    </footer>
  );
